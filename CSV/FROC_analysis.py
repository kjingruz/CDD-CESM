...
def main():
    ...
    # Convert evaluator results to COCO format for FROC analysis
    pr_ann = os.path.join(cfg.OUTPUT_DIR, "predictions.json")
    with open(pr_ann, 'w') as f:
        json.dump(evaluator._predictions, f)

    # Generate FROC curve
    gt_ann = "./data/annotations.json"  # Ground truth annotations in COCO format
    generate_froc_curve(gt_ann=gt_ann, pr_ann=pr_ann, plot_output_path="froc.png")
