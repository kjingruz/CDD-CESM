...
def main():
    ...
    parser.add_argument('--pr_ann', default='30000/predictions_coco.json', help='Path to prediction annotations')
    ...
    parser.add_argument('--plot_output_path', default='30000/froc_analysis.png', help='Output path for the plot')
