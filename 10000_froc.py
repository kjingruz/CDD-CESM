...
def main():
    ...
    parser.add_argument('--pr_ann', default='output/predictions_coco.json', help='Path to prediction annotations')
    ...
    parser.add_argument('--plot_title', default='FROC Analysis (Faster R-CNN R50-FPN)', help='Title for the plot')
    parser.add_argument('--plot_output_path', default='output/froc_analysis.png', help='Output path for the plot')
