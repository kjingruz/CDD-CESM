...
def main():
    ...
    parser.add_argument('--pr_ann', default='output_improved/predictions_coco.json', help='Path to prediction annotations')
    ...
    parser.add_argument('--plot_title', default='FROC Analysis (ResNeXt-101)', help='Title for the plot')
    parser.add_argument('--plot_output_path', default='output_improved/froc_analysis.png', help='Output path for the plot')
