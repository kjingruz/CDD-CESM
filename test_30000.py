...
def generate_predictions_coco(predictor, dataset_dicts):
    ...
    with open("30000/predictions_coco.json", "w") as f:
        json.dump(coco_results, f, cls=NumpyEncoder)

    print(f"Predictions saved in COCO format to 30000/predictions_coco.json")
...
def visualize_predictions(predictor, dataset_dicts, num_images=50):
    ...
    output_dir = os.path.join("30000", "output_images")
...
def main():
    ...
    evaluator = COCOEvaluator("cesm_test", cfg, False, output_dir="./30000/")
